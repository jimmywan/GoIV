...
public class IVPopupButton extends android.support.v7.widget.AppCompatButton {
    ...
    public void showQuickIVPreviewLook(@NonNull ScanResult scanResult) {
        ...
        if (lowest != null && highest != null) {
            ...
            text.append(scanResult.pokemon.base.name);
            if (!scanResult.pokemon.formName.isEmpty()) {
                text.append('\n');
                text.append(scanResult.pokemon.formName);
            }
            text.append('\n');
            text.append(scanResult.getIVString());
